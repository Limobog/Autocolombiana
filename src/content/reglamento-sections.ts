  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['65cc A', '7 a 10 años', 'Fondo blanco — números negros'],
        ['65cc B', '7 a 10 años', 'Fondo blanco — números negros'],
        ['85cc Novatos', '10 a 15 años', 'Fondo blanco — números negros'],
        ['85cc A', '10 a 15 años', 'Fondo blanco — números negros'],
        ['85cc B', '10 a 15 años', 'Fondo blanco — números negros'],
