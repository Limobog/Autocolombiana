...
export const REGLAMENTO_ENDURO_SECTIONS: ReglamentoSection[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Se considera edad mínima a la primera fecha de la edición y edad máxima al 1 de enero del año correspondiente.',
    ],
  },
  {
    id: 'formato',
    ...
    paragraphs: [
      'El campeonato consta de dos ediciones con formatos diferentes, ambas contra el cronómetro y con clasificación por tiempos.',
    ],
    subsections: [
      {
        title: '1.ª Edición — Sprint Enduro · 30 de agosto · Cogua Motopark',
        bullets: [
