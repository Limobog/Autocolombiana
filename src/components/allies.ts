  ...
  if (compact) {
    return `
      <div class="flex flex-wrap items-center justify-center gap-6 md:gap-10 opacity-80">
        <img src="${asset('logo-limobog-aliado.png')}" alt="LIMOBOG" class="h-8 md:h-9 w-auto object-contain grayscale hover:grayscale-0 transition-all duration-300" />
        <img src="${asset('logo-aliados.png')}" alt="Aliados — KTM, Husqvarna, GASGAS" class="h-7 md:h-8 w-auto max-w-[200px] object-contain" />
      </div>`;
  }
      ...
      <div class="mx-auto max-w-7xl px-4 relative z-10">
        ...
        <div class="flex flex-col items-center gap-10 md:flex-row md:justify-center md:items-center md:gap-16 lg:gap-24">
          <div class="flex flex-col items-center gap-3 shrink-0">
            <img src="${asset('logo-limobog-aliado.png')}" alt="LIMOBOG — Liga de Motociclismo de Bogotá"
          ...
          <div class="flex flex-col items-center gap-3 max-w-md">
            <img src="${asset('logo-aliados.png')}" alt="Marcas aliadas — KTM, Husqvarna, GASGAS"
